...
class Phoenix2014TPreprocesser:
    ...
    def _preprocess_mode(self, mode):
        info = pd.read_csv(os.path.join(self.annotations_dir, f'PHOENIX-2014-T.{mode}.corpus.csv'),
    ...
    def _preprocess_item(self, item, mode):
        frames_dir = os.path.join(self.features_dir, mode, item[0])
        video_output_dir = os.path.join(self.output_dir, mode, item[0])
...
if __name__ == "__main__":
    ...
    # 添加命令行参数
    parser.add_argument("--dataset_dir", type=str, help="", default="../phoenix2014T")
    parser.add_argument("--features_output_dir", type=str, help="",
                        default="./phoenix2014T_features_transformed")
