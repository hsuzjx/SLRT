...
class CSLDailyPatchKpsDataset(BasePatchKpsDataset):
    def __init__(
            self,
        ...
        self.video_info = pd.concat([info, splits], axis=1)
        self.video_info = self.video_info[self.video_info['split'].isin(self.mode)]
